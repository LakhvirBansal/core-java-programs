...
class LinkedHashMapCustom<K, V> {
	...
	/**
	 * Method allows you put key-value pair in LinkedHashMapCustom. If the map already contains a mapping for the key,
	 * the old value is replaced. Note: method does not allows you to put null key thought it allows null values.
	 * Implementation allows you to put custom objects as a key as well. Key Features: implementation provides you with
	 * following features:- >provide complete functionality how to override equals method. >provide complete
